...
class CNN(nn.Module):
    ...
    def __init__(self, number_actions):
        ...
        self.convolution1 = nn.Conv2d(in_channels = 1, out_channels = 64, kernel_size = 6)
        self.convolution2 = nn.Conv2d(in_channels = 64, out_channels = 64, kernel_size = 4)
        self.convolution3 = nn.Conv2d(in_channels = 64, out_channels = 128, kernel_size = 3)
        self.fc1 = nn.Linear(in_features = self.count_neurons((1, 45, 65)), out_features = 40)
...
try:
    while(True):
        ...
        if fini == False:
            ...
            print("--- End memory ---")
            print("--- Depart ---")
            for batch in memory.sample_batch(256):
            ...
            print("Saving brain...")
            torch.save(cnn, "D:\\envPython\\OsuIA\\training\\brain-{}.ty".format(nb_epochs))
            print("Successful")
            print("---- FIN -----")
        else:
