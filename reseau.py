...
class CNN(nn.Module):
    ...
    def __init__(self, number_actions):
        ...
        self.convolution1 = nn.Conv2d(in_channels = 1, out_channels = 64, kernel_size = 4)
        ...
        self.fc1 = nn.Linear(in_features = self.count_neurons((1, 75, 100)), out_features = 40)
...
# Building an AI
cnn = CNN(9).to(device)
#cnn = torch.load("D:\\envPython\\OsuIA\\training\\brain2.ty").to(device)
#cnn.eval()
